<header class="admin-panel-header header header-sticky mb-4" >
    <div class="container-fluid">
        @auth
            ...
            <ul class="header-nav d-none d-md-flex">
                <li class="nav-item"><a class="nav-link" href="{{ route('admin.dashboard') }}">داشبورد</a></li>
            ...
            <ul class="header-nav ms-3">
                <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#"
                        ...
                        <div class="avatar avatar-md"><img class="avatar-img" src="{{ asset('img/avatars/3.jpg') }}"
        ...
        @else
            ...
            <ul class="header-nav ms-3">
                <a type="button" href="{{ url('/register') }}" class="btn btn-info text-white">ثبت نام</a>
                <a href="{{ url('/login') }}" class="btn btn-danger text-white mx-3">ورود</a>
            </ul>
